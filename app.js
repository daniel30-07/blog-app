...
app.use(expressSanitizer()); //Safety -> avoid script JS in the body blog
...
app.post("/blogs", (req, res) => {
    //create blog
    req.body.blog.body = req.sanitize(req.body.blog.body); //Safety -> avoid script JS in the body blog
